...
const char* TESTMIRRORSHADER = "TESTMIRRORSHADER";
...
const char* POSITIONTEXTURENOMVPSHADER = "POSITIONTEXTURENOMVPSHADER";
...
const static defaultShaderData s_shaderMap[] = {
   ...
   { TESTMIRRORSHADER,TESTMIRRORSHADER_VERT,TESTSHADER_FRAG	},

   { POSITIONTEXTURESHADER,POSITIONTEXTURE_VERT,POSITIONTEXTURE_FRAG },
   { POSITIONTEXTURENOMVPSHADER,POSITIONTEXTURENOMVP_VERT,POSITIONTEXTURENOMVP_FRAG },
